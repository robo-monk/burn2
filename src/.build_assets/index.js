...
//function injectStyle(name){
    //if (! name in styles) return console.error(`could not find ${name}.scss in burn2/src/styles`) 
    //pragmajs.util.addStyles(styles[name])
//}

//function SVG(name, fill) {
    //if (! name in icons) return console.error(`could not find ${name}.scss in burn2/src/styles`)
    //let i = icons[name]
